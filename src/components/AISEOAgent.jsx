...
// Sarcini presetate (audit, meta, blog, social, cuvinte cheie) + chat liber,
// cu context real din site (categorii + materiale). Răspunsurile se pot
// copia sau descărca ca .md.
// =====================================================================
  ...
  return (
    <div style={{ ...box, marginTop: 18 }}>
      ...
      <p style={{ fontSize: '.85rem', color: 'var(--text-light)', marginBottom: 12 }}>
        Analizează site-ul (folosind conținutul real din baza de date) și produce materiale gata de folosit.
