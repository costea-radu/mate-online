          ...
          <div style={{ background: '#fff', borderRadius: 14, padding: '40px 48px', boxShadow: 'var(--shadow)' }}>
            ...
            <Section title="7. Servicii terțe">
              ...
              <ul style={{ paddingLeft: 20, marginTop: 8, display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <li><strong>Anthropic (Claude)</strong> — generarea de conținut educațional (inclusiv seturile de exerciții din „Meditații") și unelte administrative interne (de ex. articole și optimizări ale paginilor). Nu îi sunt transmise numele, e-mailul sau alte date care te identifică; la exercițiile de remediere primește exercițiul greșit și răspunsul dat (vezi secțiunea 8). <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--navy)', fontWeight: 600 }}>Politica Anthropic</a></li>
              </ul>
            </Section>
            ...
            <Section title="8. Profesorul Virtual (AI)">
              ...
              <p style={{ marginTop: 12 }}>
                Pentru generarea de conținut educațional și pentru unelte administrative interne, platforma folosește și modele <strong>Claude</strong> de la <strong>Anthropic, PBC</strong> (Statele Unite). Acestea sunt folosite în două situații: (a) uneltele administrative ale echipei — generarea și verificarea materialelor din bibliotecă, articolele și optimizările paginilor, care lucrează cu materialele și statisticile agregate ale platformei; (b) generarea seturilor de exerciții din rubrica „Meditații cu Profesorul Virtual". În a doua situație, modelul primește tema/capitolul la care lucrezi și nivelul tău (începător/mediu/avansat), iar la exercițiile de remediere primește și exercițiul la care ai greșit împreună cu răspunsul dat de tine — <strong>fără numele, adresa de e-mail sau alte date care te identifică</strong>. Conversațiile din chat, fotografiile și înregistrările vocale NU sunt transmise către Anthropic. Ca și la OpenAI, datele trimise prin API <strong>nu sunt folosite pentru antrenarea modelelor</strong>. Vezi și <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--navy)', fontWeight: 600 }}>Politica de confidențialitate Anthropic</a>.
              </p>
            </Section>
