...
//   task: 'audit'|'meta'|'blog'|'social'|'keywords'|'chat'
// =====================================================================
...
Reguli: răspunzi în română, concret și acționabil, fără generalități. Când scrii conținut (meta, articole, postări), e gata de copiat. Ține cont că site-ul e SPA client-side (recomandările tehnice SEO să menționeze prerender/SSR/meta dinamice unde e relevant.)
